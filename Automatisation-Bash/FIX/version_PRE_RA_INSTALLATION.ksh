...
LOGFILE=${fichierLogPreDesInstall}
...
## Les répertoires à nettoyer dans le cadre de la désinstallation:
...
for REP in /var/opt/data/flat/od1cdc/files/data/tmp/STT \
           /var/opt/data/flat/od1cdc/files/data/tmp/RCT \
